...
def main():
    ...
    adj_list_type1 = AdjacencyList(node_num=5, adj_list=[(0, 2), (2, 1), (1, 3), (1, 4)], device=gnn.device)
    adj_list_type2 = AdjacencyList(node_num=5, adj_list=[(0, 0), (0, 1)], device=gnn.device)

    node_representations = gnn.compute_node_representations(initial_node_representation=torch.randn(5, 64),
